...
const createUser = async (req, res) => {
  ...
  const query =
    "INSERT INTO students(stu_id, name, password, year, dept_id) VALUES($1, $2, $3, $4, $5) returning *";
...
const loginUser = async (req, res) => {
  ...
  let query = "SELECT * from students where stu_id=$1";
  ...
  const token = generateJWTTOken(rows[0].stu_id, rows[0].name);
